...
<?php echo $this->Form->create('Deposito', array('type' => 'post', 'class' => 'form-inline')); ?>
	<fieldset>
		<legend><h2><b><?php echo __('Editar Bodegas'); ?></b></h2></legend>
		<?php echo $this->Form->input('menuvert', array('type' => 'hidden', 'value' => '15', 'id' => 'menuvert'))?>
                ...
                <div class="row"> 
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('prefijo', array('class' => 'form-control', 'label' => '', 'placeholder' => 'Prefijo de la Bodegas')); ?>
                    </div>      
                </div><br>      
                ...
                <div class="row">                     
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('nota', array('class' => 'form-control', 'label' => '', 'placeholder' => 'Agregar nota para la Bodegas')); ?>
                    </div> 
                </div><br><br> 
	</fieldset>
