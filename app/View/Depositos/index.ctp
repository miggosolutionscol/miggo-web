    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group ">
                ...
                <?php echo $this->Form->input('nombre', array('label' => '', 'name' => 'nombre', 'placeholder' => 'Nombre de la Bodegas', 'type' => 'text','class' => 'form-control' , 'value' => $nombre)); ?>
        </div>
    ...
    <div class="row justify-content-md-center">
        <div class="col col-lg-2">
            <button type="button" class="btn btn-primary">
                <?php echo $this->Html->link(__('Nuevo Bodegas'), array('action' => 'add'), ["style" => "color:white;"]); ?>
            </button>
        </div>
        ...
        <div class="container">
            <table cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->image('png/list-10.png', array('title' => 'Ver Bodegas', 'alt' => __('Brownies'), 'width' => '20px', 'url' => array('action' => 'view', $deposito['Deposito']['id']))); ?>
                        <?php echo $this->Html->image('png/list-12.png', array('title' => 'Editar Bodegas', 'alt' => __('Brownies'), 'width' => '20px', 'url' => array('action' => 'edit', $deposito['Deposito']['id']))); ?>
                        <?php
echo $this->Form->postLink(
    $this->Html->image('png/list-2.png', array('title' => 'Eliminar Bodegas', 'alt' => __('Brownies'), 'width' => '20px')), //imagen
