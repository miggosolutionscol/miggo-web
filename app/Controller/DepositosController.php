 ...
 */
	public function view($id = null) {
		...
		if (!$this->Deposito->exists($id)) {
			throw new NotFoundException(__('El bodega no existe.'));
		}
	...
	public function add() {
		...
		if ($this->request->is('post')) {
                    ...
                    if ($this->Deposito->save($this->request->data)) {
                            ...
                            $this->Session->setFlash(__('El bodega no pudo ser guardado. Por favor, inténtelo de nuevo.'));
                    }
		}
	...
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Deposito->save($this->request->data)) {
				...
				$this->Session->setFlash(__('El bodega no ha sido guardado. Por favor, inténtelo de nuevo.'));
			}
		} else {
			$options = array('conditions' => array('Deposito.' . $this->Deposito->primaryKey => $id));
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Deposito->delete()) {
			$this->Session->setFlash(__('El bodega ha sido eliminado.'));
		} else {
			$this->Session->setFlash(__('El bodega no ha sido eliminado. Por favor, inténtelo de nuevo.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
